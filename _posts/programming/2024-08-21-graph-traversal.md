...
3. [**Shortest Distance from All Buildings**](https://leetcode.com/problems/shortest-distance-from-all-buildings/)
4. [**Binary Tree Level Order Traversal**](https://leetcode.com/problems/binary-tree-level-order-traversal/)
5. [**Connected Components in an Undirected Graph**](https://leetcode.com/problems/number-of-connected-components-in-an-undirected-graph/)
6. [**Minimum Depth of Binary Tree**](https://leetcode.com/problems/minimum-depth-of-binary-tree/)
7. [**Find the Distance in a Binary Tree**](https://leetcode.com/problems/find-distance-in-a-binary-tree/)
...
1. [**Traveling Salesman Problem**](https://leetcode.com/problems/traveling-salesman-problem/)
...
8. [**Largest Rectangle in a Binary Matrix**](https://leetcode.com/problems/largest-rectangle-in-a-binary-matrix/)
9. [**Design a Search Autocomplete System**](https://leetcode.com/problems/design-search-autocomplete-system/)
