...
4. [**Trim a Binary Search Tree**](https://leetcode.com/problems/trim-a-binary-search-tree/)
5. [**Range Sum of BST**](https://leetcode.com/problems/range-sum-of-bst/)
6. [**Search in a Binary Search Tree**](https://leetcode.com/problems/search-in-a-binary-search-tree/)
...
6. [**All Elements in Two Binary Search Trees**](https://leetcode.com/problems/all-elements-in-two-binary-search-trees/)
7. [**Balance a Binary Search Tree**](https://leetcode.com/problems/balance-a-binary-search-tree/)
...
4. [**Largest BST Subtree**](https://leetcode.com/problems/largest-bst-subtree/)
5. [**Smallest Rectangle Enclosing Black Pixels**](https://leetcode.com/problems/smallest-rectangle-enclosing-black-pixels/)
6. [**Design and Implement a Data Structure for a Persistent BST**](https://leetcode.com/problems/design-and-implement-a-data-structure-for-a-persistent-bst/)
7. [**Maximum Sum BST in Binary Tree**](https://leetcode.com/problems/maximum-sum-bst-in-binary-tree/)
8. [**Binary Search Tree to Greater Sum Tree**](https://leetcode.com/problems/binary-search-tree-to-greater-sum-tree/)
